...
https://resources.beecrowd.com/gallery/images/novos/Searching%20for%20Nessy_C.jpg

https://resources.beecrowd.com/gallery/images/novos/Searching%20for%20Nessy_A.gif

https://resources.beecrowd.com/gallery/images/novos/Searching%20for%20Nessy_C.gif
...
var numberTest = lines.shift();

for(let i = 0; i < numberTest; i++){
    const currentLine = lines.shift(); 
    if (!currentLine) break;
    const [n, m] = currentLine.split(" ").map(Number);
    const sonars = (n / 3 | 0) * (m / 3 | 0); // | 0 to divisor
    console.log(sonars);
}